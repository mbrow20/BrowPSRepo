...
SimulationWithCovMat=function(CovMatrixWt,data1,Sims,mu_beta){
  ...
  TFrame<<-TFrame
  write.table(TFrame, file="TFrameEMImpute.csv", col.names = TRUE, row.names = FALSE, sep=",",append = FALSE)
  fileConn1<-file("BiasSummEMImpute1.txt")
  fileConn2<-file("BiasSummEMImpute2.txt")
  fileConn3<-file("BiasSummEMImpute3.txt")
