...
SimulationWithCovMat=function(CovMatrixWt,data1,Sims,mu_beta){
  ...
  View(PercMeanDiffTableMeta)
  write.table(TFrameMeta, file="TFrameMetaJOMOMI.csv", col.names = TRUE, row.names = FALSE, sep=",",append = FALSE)
  
  fileConn1<-file("BiasJOMO1.txt")
  fileConn2<-file("BiasJOMO2.txt")
  fileConn3<-file("BiasJOMO3.txt")
