...
SimulationWithCovMat=function(CovMatrixWt,data1,Sims,mu_beta){
  ...
  write.table(TFrameMeta, file="TFrameSPSSMI.csv", col.names = TRUE, row.names = FALSE, sep=",",append = FALSE)
  View(TFrameMeta)
  ...
  View(PercMeanDiffTableMeta)
  fileConn1<-file("BiasSummSPSSMI1.txt")
  fileConn2<-file("BiasSummSPSSMI2.txt")
  fileConn3<-file("BiasSummSPSSMI3.txt")
